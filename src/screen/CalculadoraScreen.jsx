...
export const CalculadoraScreen = () => {
  ...
  return (
    <View style={styles.calculadoraContainer}>
      {/* Si el numeroAnterior es igual a 0 que se oculte. */}
      {numeroAnterior !== '0' && (
      ...
      <View style={styles.fila}>
        ...
        <BotonCalculadora texto="/" color="#FF9427" accion={btnOperacion} />
      </View>
      ...
      <View style={styles.fila}>
        ...
        <BotonCalculadora texto="X" color="#FF9427" accion={btnOperacion} />
      </View>
